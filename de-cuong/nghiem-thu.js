...
function _maHocPhan(m,t){
  ...
  return {linhvuc:m[1],dang:'dddE',ct:'Chương trình tiên tiến',lang:'en',mota:'chương trình tiên tiến, học phần giảng dạy bằng tiếng Anh'}; }
...
/* Hướng dẫn xây dựng CĐR CTĐT và học phần (FTU, TB 424): CLO viết theo SMART, mở đầu bằng động từ chỉ mức năng lực (Phụ lục 1-3),
   số CLO thường 3-6, mỗi CLO chỉ nên đáp ứng một PLO. Danh sách động từ lấy từ ba phụ lục (kiến thức, kỹ năng, thái độ) cộng các động từ đo được thường gặp. */
const CDR_VERBS={
  vn:['nhận diện','nhận biết','nhớ lại','nhớ','nêu tên','nêu','mô tả','gọi tên','gán tên','trích dẫn','liệt kê','nối','lựa chọn','chọn','vẽ','định nghĩa','nhắc lại','chỉ ra','dịch','phát biểu','phân loại','tóm kết','tóm tắt','so sánh','khái quát hóa','khái quát hoá','khái quát','giải thích','minh họa','minh hoạ','phân biệt','sắp xếp lại','sắp xếp','viết lại','trình bày','diễn giải','diễn đạt','vận dụng','áp dụng','sử dụng','triển khai','thực hiện','vận hành','đo lường','điều chỉnh','chuyển hóa','chuyển hoá','khám phá','giải quyết','tính toán','tính','thay đổi','xây dựng','thiết lập','điều tra','mở rộng','tái cấu trúc','thể hiện','dự báo','dự đoán','phát hiện','phân tích','tổng hợp','chia','tìm ra','tìm','phản biện','tranh luận','sơ đồ hóa','sơ đồ hoá','tối đa hóa','tối thiểu hóa','đánh giá','thẩm định','thẩm tra','ngoại suy','suy luận','suy ra','rút ra','đồng tình','phản đối','thỏa hiệp','ủng hộ','xác trị','xác nhận','xác định','xếp hạng','phán quyết','tiên đoán','đưa ra','kết luận','chẩn đoán','biện luận','lập luận','luận giải','nhận định','nhận xét','bình luận','phê phán','đối chiếu','viết','soạn thảo','soạn','báo cáo','thiết kế','kết hợp','sáng tác','chuẩn hóa','chuẩn hoá','hệ thống hóa','hệ thống hoá','lập kế hoạch','lập công thức','lập trình','lập','hoạch định','phát triển','lắp ráp','cải thiện','phát minh','sáng chế','tổ chức lại','tổ chức','sửa lỗi','sửa chữa','sửa','tuân thủ','tuân theo','sao chép','chép lại','theo dõi','lặp lại','bắt chước','so khớp','tái hiện','nhân rộng','quan sát','thử','căn chỉnh','hiệu chỉnh','hoàn thành','tiến hành','biểu diễn','sản xuất','tái tạo','phác thảo','phối hợp','giữ gìn','giữ','kiểm soát','kiểm định','kiểm tra','thành thục','thành thạo','làm chủ','hoàn thiện','thay thế','đa dạng hóa','đa dạng hoá','hoàn chỉnh','sáng tạo','tạo ra','tạo','chế tác','kiến tạo','chú ý','lắng nghe','chấp nhận','đọc hiểu','đọc','ghi nhận','đặt câu hỏi','tham gia','thảo luận','trả lời','kể lại','thực hành','phản hồi','tôn trọng','chia sẻ','đề xuất','đề ra','khen ngợi','ưu tiên','liên hệ','hình thành','hành động','bảo vệ','cam kết','dẫn dắt','làm việc','giao tiếp','thuyết trình','ước lượng','ước tính','mô hình hóa','mô hình hoá','mô phỏng','chứng minh','vận động','quản lý','quản trị','điều hành','tích hợp','lượng hóa','lượng hoá','tra cứu','thu thập','xử lý','khai thác','tư vấn','tổng kết','phản ánh','tính được'],
  en:['identify','recognize','recognise','recall','retrieve','name','describe','label','quote','list','match','select','choose','draw','define','repeat','point out','translate','classify','sort','summarize','summarise','compare','generalize','generalise','explain','illustrate','distinguish','rearrange','reorder','rewrite','present','interpret','discuss','outline','paraphrase','apply','use','utilize','utilise','execute','implement','operate','measure','adapt','modify','transfer','convert','explore','solve','calculate','compute','change','construct','establish','investigate','expand','restructure','demonstrate','predict','forecast','detect','analyze','analyse','discriminate','differentiate','synthesize','synthesise','destructure','correlate','criticize','criticise','critique','debate','characterize','characterise','diagram','maximize','maximise','minimize','minimise','examine','assess','evaluate','appraise','extrapolate','deduce','infer','approve','disapprove','reconcile','support','validate','confirm','verify','grade','rank','rate','judge','conclude','diagnose','justify','argue','recommend','write','report','design','build','combine','incorporate','compose','standardize','standardise','hypothesize','hypothesise','develop','assemble','code','program','improve','invent','reorganize','reorganise','debug','correct','plan','perform','formulate','cultivate','create','produce','propose','generate','adhere','copy','duplicate','follow','imitate','reenact','replicate','observe','try','align','calibrate','complete','conduct','recreate','repair','sharpen','coordinate','balance','control','master','replace','alter','fix','vary','originate','attend','listen','accept','read','acknowledge','ask','comply','conform','participate','answer','tell','practice','practise','respond','respect','share','suggest','maintain','praise','prioritize','prioritise','relate','form','act','defend','commit','lead','work','communicate','collaborate','manage','integrate','organize','organise','estimate','test','derive','model','simulate','prove','determine','carry out','make','exhibit','display','show','engage','contribute','adopt','uphold','critically evaluate','critically analyze','critically analyse','critically assess']};
const CDR_VAGUE={vn:['hiểu biết','hiểu rõ','hiểu được','hiểu','biết được','biết','nắm được','nắm vững','nắm bắt','nắm','nhận thức được','nhận thức','có kiến thức','có hiểu biết','có khả năng','có năng lực','có kỹ năng','có thái độ','có thể','được trang bị','được cung cấp','trang bị','cung cấp','làm quen','quen với','tiếp cận'],
  en:['understand','know','learn','appreciate','be familiar','become familiar','be aware','become aware','comprehend','realize','realise','grasp','have knowledge','have an understanding','have a knowledge','gain','acquire','be able to','have the ability','be exposed','get to know','be introduced']};
const CDR_NONVERB={vn:['sinh viên','người học','học viên','nghiên cứu sinh','kiến thức','kỹ năng','thái độ','khả năng','năng lực','các','những','sự','việc','về','nội dung','học phần','môn học','có','được','giúp','trang bị cho','cung cấp cho'],
  en:['students','student','the students','the student','learners','learner','the learner','the learners','knowledge','skills','skill','ability','abilities','attitude','attitudes','understanding','an understanding','a knowledge','the ability','to','provide','equip','help']};
const cdrStrip=t=>lower(t).replace(/^[-–•*\s]+/,'').replace(/^clo\s*\d+(\.\d+)*\s*[:.\-–]?\s*/,'').trim();
function cdrStarts(t,list){ return list.some(v=>t.startsWith(v)&&(t.length===v.length||!/\p{L}/u.test(t.charAt(v.length)))); }
/* cdrClo(texts, lang) -> {nonverb:[{i,t}], vague:[{i,t}], ok:[i], unknown:[{i,t}]}; ngôn ngữ của từng CLO tự nhận (tiếng Việt có dấu / tiếng Anh) */
function cdrClo(texts,lang){ const out={nonverb:[],vague:[],ok:[],unknown:[]}; (texts||[]).forEach((raw,i)=>{ const t=cdrStrip(raw); if(!t) return; const L=isVietnamese(t)?'vn':(lang==='en'||!/[À-ɏḀ-ỿ]/.test(t)?'en':'vn'); const head=t.split(/\s+/).slice(0,6).join(' ');
    if(cdrStarts(t,CDR_NONVERB[L])) out.nonverb.push({i:i+1,t:head}); else if(cdrStarts(t,CDR_VAGUE[L])) out.vague.push({i:i+1,t:head}); else if(cdrStarts(t,CDR_VERBS[L])) out.ok.push(i+1); else out.unknown.push({i:i+1,t:head}); }); return out; }
/* Số CLO theo Hướng dẫn: thường 3-6 */
function cdrCount(n){ if(!n) return null; if(n<3) return {status:'warn',t:`Học phần chỉ có ${n} CLO`,d:'Hướng dẫn xây dựng CĐR của Trường: số CLO thường từ 3 đến 6. Ít hơn 3 thì xem lại đã bao quát các PLO mà học phần đảm nhiệm chưa.'}; if(n>6) return {status:'warn',t:`Học phần có ${n} CLO, nhiều hơn 6`,d:'Hướng dẫn xây dựng CĐR: số CLO thường từ 3 đến 6, hơn 6 khi thật cần. Mỗi CLO là một vấn đề lớn, cân bằng giữa chung chung và quá chi tiết; CLO nhỏ có thể gộp.'}; return {status:'pass',t:`Số CLO (${n}) trong khoảng 3 đến 6 theo Hướng dẫn xây dựng CĐR`}; }
...
function check(blocks,opts){
  ...
  if(idx['3.1.']!=null&&idx['3.2.']!=null){ const seg=paras.slice(idx['3.1.']+1,idx['3.2.']); nCLO=seg.filter(p=>C.clo.test(p.text)).length; meta.nCLO=nCLO;
    ...
    // Hướng dẫn xây dựng CĐR: số CLO 3-6; CLO mở đầu bằng động từ hành động đo được
    const cloTexts=seg.filter(p=>C.clo.test(p.text)).map(p=>p.text.replace(/^-?\s*CLO\s*\d+(\.\d+)*\s*[:.\-–]?\s*/i,'').trim()); meta.cloTexts=cloTexts;
    const cc=cdrCount(nCLO); if(cc) add(G2,cc.status,cc.t,cc.d||'');
    const cd=cdrClo(cloTexts,lang); const li=x=>`CLO${x.i}: "${x.t}…"`;
    if(cd.nonverb.length) add(G2,'warn',`${cd.nonverb.length} CLO không mở đầu bằng động từ hành động`,cd.nonverb.map(li).join('; ')+'\nHướng dẫn xây dựng CĐR của Trường: CLO viết theo SMART, mở đầu bằng động từ chỉ mức năng lực (Phụ lục 1-3: nhận diện, giải thích, vận dụng, phân tích, đánh giá, thiết kế…). Bỏ chủ ngữ "Sinh viên", không mở đầu bằng "Kiến thức về", "Có khả năng".');
    if(cd.vague.length) add(G2,'warn',`${cd.vague.length} CLO dùng động từ khó đo lường`,cd.vague.map(li).join('; ')+'\n"Hiểu", "biết", "nắm được", "có khả năng" không nằm trong bảng động từ của Hướng dẫn xây dựng CĐR vì không đo được. Thay bằng động từ đo được: giải thích, trình bày, phân biệt, vận dụng, phân tích, đánh giá…');
    if(nCLO&&!cd.nonverb.length&&!cd.vague.length) add(G2,'pass',cd.unknown.length?`CLO mở đầu bằng động từ; ${cd.unknown.length} CLO dùng từ ngoài bảng gợi ý của Hướng dẫn CĐR`:'Mọi CLO mở đầu bằng động từ hành động trong bảng gợi ý của Hướng dẫn xây dựng CĐR',cd.unknown.length?cd.unknown.map(li).join('; ')+'\nTự kiểm: từ mở đầu phải là động từ đo được.':''); }
  ...
  if(!mat) add(G2,'fail','Không có bảng ma trận 3.2 (CLO tới PLO)','Mẫu không kèm sẵn bảng này, phải dựng thêm: các dòng CLO và dòng tổng của học phần.');
    ...
    const multiClo=cloRows.map(r=>({n:(r[cloCol]||'').trim(),k:r.slice(cloCol+1).filter(c=>c.trim()).length})).filter(x=>x.k>1); if(multiClo.length) add(G2,'warn',`${multiClo.length} CLO đáp ứng nhiều hơn một PLO trong ma trận 3.2`,multiClo.map(x=>`${x.n}: ${x.k} PLO`).join('; ')+'\nHướng dẫn xây dựng CĐR của Trường: mỗi CLO chỉ nên đáp ứng một PLO. Học phần đóng góp cho nhiều PLO thì tách CLO theo từng PLO.'); else if(cloRows.length&&cloRows.some(r=>r.slice(cloCol+1).some(c=>c.trim()))) add(G2,'pass','Mỗi CLO đáp ứng đúng một PLO trong ma trận 3.2');
...
global.NghiemThu={VERSION,parseDocx,check,checkFile,readDocx,parseCtdt,loadCtdt,extractTables,maHocPhan,maTheoNgonNgu,bacHocPhan,cdrClo,cdrCount,num,fmt,CFG};
})(window);
