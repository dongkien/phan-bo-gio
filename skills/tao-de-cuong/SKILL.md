...
7. **Ma trận 3.2** gồm các dòng CLO→PLO **và dòng cuối "Học phần"** (đúng tên, không "Tổng phân nhiệm") = ánh xạ tổng của học phần tới từng PLO (đúng dòng trong ma trận CTĐT). **Ô giao CLO×PLO ghi MỨC đóng góp 1, 2 hoặc 3; CLO dùng để đánh giá PLO thì ghi thêm ",A" (vd "3,A"). KHÔNG đánh dấu "X"** (sếp chốt 8/9/2026, mẫu DTU301).
...
17. **Mã học phần và ngôn ngữ (sếp chốt 8/9/2026):** mã = 3 chữ cái lĩnh vực + (3 chữ số: chương trình tiêu chuẩn, tiếng Việt | H+3 số: CLC/ĐHNNQT/ĐHPTQT nhưng học phần này dạy tiếng Việt | E+3 số: CLC/ĐHNNQT/ĐHPTQT dạy tiếng Anh | 3 số+E: chương trình tiên tiến, tiếng Anh). Mã PHẢI nhất quán với CTĐT và ngôn ngữ đề cương: BẢN TIẾNG ANH của học phần mang mã 3 chữ cái + E + 3 chữ số (QLY801 → QLYE801); ddd/Hddd = bản tiếng Việt.
